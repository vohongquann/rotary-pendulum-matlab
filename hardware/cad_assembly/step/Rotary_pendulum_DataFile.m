...
smiData.Solid(1).mass = 1.217268;  % kg
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 0.0088288744254015877;  % kg
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(3).mass = 0.0035121801917199183;  % kg
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 0.028627562126451865;  % kg
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(5).mass = 0.0069431161422486252;  % kg
