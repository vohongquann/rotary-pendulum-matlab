...
from policy_tensor_su import GetWeightSwingUp
from policy_tensor_b import GetWeightBalance
...
class SACTrainer:
    ...
    def train(self, episodes=500, max_steps=1000, window_length=10,
              stop_avg_value=50, train_repeat_per_episode=10, save_directory='sac_model_su.pth'):
        """
        ...
        try:
            ...
            self.save_checkpoint("sac_model_b.pth")
...
class ActorSU(ActorNet):
    ...
    def load_model(self, model='sac_model_su.pth'):
...
class ActorB(ActorNet):
    ...
    def load_model(self, model='sac_model_b.pth'):
...
class CriticB(QNet):
    ...
    def load_model(self, path='sac_model_b.pth', critic='q1', device=None):
        """
